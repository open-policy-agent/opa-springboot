...
import org.openpolicyagent.opa.springboot.autoconfigure.OPAAutoConfiguration;
...
public abstract class BaseIntegrationTest {
    ...
    /**
     * Besides OPA default port ({@code opaPort}), OPA is exposed under
     * {@code localhost:8282/customprefix} using
     * Nginx.<br/>
     * Nginx configuration is provided in {@code src/test/resources/nginx.conf}
     * file.
     */
    ...
    // CHECKSTYLE:OFF
    /*
     * Checkstyle is disabled here to allow protected fields. Morover, Checkstyle
     * wants opaContainer to 'be private and
     * have accessor methods', which seems pointless and will probably mess up test
     * containers.
     */
    @Mock
    ...
    public static GenericContainer<?> opaContainer = new GenericContainer<>(
            ...
            .withCommand(
                    "run -s --authentication=token --authorization=basic --bundle /policy --addr=0.0.0.0:" + OPA_PORT)
    ...
    /**
     * This is used to create a mock {@link Authentication} object where most of the
     * fields are null, to resolve
     ...
     * path.<br/>
     * Note that this does stringify all JSON types, including null, so there could
     * be some slight shadowing problems.
     */
    ...
    /**
     * Create a human-readable list of differences between two objects. The possible
     * paths are enumerated with
     * {@link #jsonList(Object)}, and they are retrieved using
     * {@link #jsonGet(Object, String)}. This does mean that
