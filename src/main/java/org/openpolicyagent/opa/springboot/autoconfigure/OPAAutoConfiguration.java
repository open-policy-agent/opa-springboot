package org.openpolicyagent.opa.springboot.autoconfigure;
...
import org.openpolicyagent.opa.springboot.authorization.OPAAuthorizationEventPublisher;
...
/**
 * {@link EnableAutoConfiguration Auto-configuration} for OPA authorization
 * support.
 */
@AutoConfiguration
...
public class OPAAutoConfiguration {
    ...
    /**
     * Create an {@link OPAAuthorizationManager} bean using {@link OPAClient} bean
     * and {@link OPAProperties#getPath()}.
     */
    @Bean
    ...
    /**
     * Create an {@link OPAInputValidator} to validate the OPA input's required
     * fields before sending request to the
     * OPA server.
     */
    @Bean
    ...
    /**
     * Create an {@link OPAAuthorizationEventPublisher} to publish denied/granted
