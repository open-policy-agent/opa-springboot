...
public final class OPAInputValidator {
     ...
     *                               <li>If {@value InputConstants#CONTEXT} is
     *                               available, {@value InputConstants#CONTEXT}.
    ...
    private void validateKey(Map<String, Object> input, String entity, String key) throws AccessDeniedException {
