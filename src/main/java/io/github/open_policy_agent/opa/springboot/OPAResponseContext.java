...
public class OPAResponseContext {
     ...
     * structured data in addition to the
     ...
     * {@link AuthorizationDecision}s. Currently, it will
     * select the search key if it is present in the {@code reasonUser}, and if not
     * it will select the key which sorts
